  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Data Integrations', href: '/integrations' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Transforming business intelligence with advanced analytics and real-time insights.
                Trusted by over 10,000 companies worldwide to make data-driven decisions.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (555) DATA-HELP</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get exclusive analytics tips and industry trends. Unsubscribe anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Made with <Heart className="size-3 text-accent fill-current" /> by our analytics
                team
              </span>
            </div>
